			...
			<div className="flex flex-col max-w-sm mx-auto gap-10">
				...
				<div className="">
					...
					<ul className="grid cols-span-1 gap-y-2 mt-7">
						<li className="flex items-start gap-2">
							...
							<span className="flex-1">Почему <b>сложно отстаивать личные границы</b> в отношениях?</span>
						</li>
						<li className="flex items-start gap-2">
							<MinusIcon className="mt-1 w-5" />
							<span className="flex-1">Что нужно проработать, чтобы <b>перестать гадать "любит/не любит"</b> и тревожиться о том, все ли хорошо в отношениях?</span>
						</li>
						<li className="flex items-start gap-2">
							<MinusIcon className="mt-1 w-5" />
							<span className="flex-1">Бесконечное <b>насилие над собой</b>: сколько бесконечно "надо", "я должна" живут у нас в голове...</span>
						</li>
						<li className="flex items-start gap-2">
							<MinusIcon className="mt-1 w-5" />
							<span className="flex-1">Вы же слышали про три принципа <b>защиты от стресса</b>: бей, беги, замри? Оказывается, есть и четвертая стратегия: <b>"стань удобным"</b></span>
						</li>
					</ul>
				</div>
				...
				<div className="text-center">
					<Link
						...
						href='https://t.me/+xW96HEvD36ExY2Ni'
					>
