	...
	return (
		<div className="">
			...
			<p className="mt-6 text-gray-800">
				Я могу гарантировать максимум вовлечения в вас и в ваши истории. Также я гарантирую высокое качество тех знаний, которые будут транслироваться на курсе. Но <strong className="font-bold">ваш результат зависит так же и от вас</strong>.
			</p>

			<p className="mt-6 text-gray-800">
				Если вы готовы поработать над собой и взять ответственность за свою жизнь, то добро пожаловать на курс!
			</p>
