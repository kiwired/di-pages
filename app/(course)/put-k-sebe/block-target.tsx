...
export function BlockTarget() {
	...
	const features = [
		...
		{
			name: 'Научитесь прощать свои ошибки и неидеальность',
			icon: SparklesIcon,
		},
		{
			name: 'Познакомитесь с внутренними препятствиями на пути к счастливой жизни',
			icon: SparklesIcon,
		},
		{
			name: 'Научитесь работать со своими страхами и критичностью ',
			icon: SparklesIcon,
		},
		{
			name: 'Улучшите отношения с собой и окружающими',
			icon: SparklesIcon,
		},
		{
			name: 'Поймете свои настоящие чувства и желания',
			icon: SparklesIcon,
		},
	]
