...
export const BtnAction = ({ href, title, size = 'medium', block }: { href: string, title: string, size?: Size, block?: boolean }) => {
	...
	const className = clsx(
		'rounded bg-indigo-600 font-semibold text-white uppercase shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600',
		{
			'inline-block': block !== true,
			'block text-center': block === true,
